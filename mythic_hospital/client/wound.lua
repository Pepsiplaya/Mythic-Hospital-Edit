...
AddEventHandler('mythic_hospital:client:FieldTreatLimbs', function()
	...
	exports['mythic_notify']:DoCustomHudText('inform', 'You\'re completely healed', 5000)
end)
...
AddEventHandler('mythic_hospital:client:FieldTreatBleed', function()
	...
	exports['mythic_notify']:DoCustomHudText('inform', 'You reduce the bleeding', 5000)
end)
